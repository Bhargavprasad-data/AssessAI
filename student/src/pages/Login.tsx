  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (user.role !== 'student') {
        setError(`Access Denied: You are logged in as a ${user.role}. This portal is exclusively for students.`);
        return;
      }
      navigate('/student/dashboard');
    } catch (err: any) {
      setError(err.message || 'Login failed. Please verify student credentials.');
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="w-full max-w-md relative z-10 my-6">
        ...
        <div className="text-center mb-6">
          ...
          <p className="dark:text-slate-400 text-slate-500 text-xs sm:text-sm mt-1.5">
            AI Adaptive Assessments & Smart Proctoring
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="student@assessai.edu"
