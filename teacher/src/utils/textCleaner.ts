const META_PREFIX_PATTERNS = [
  ...
  /^(?:According to|Based on|As stated in|As mentioned in|As discussed in|Under complex constraints|Under the constraints)\s+[^,?:;]*?(?:chunk|section|material|passage|text|document)[^,?:;]*?[,:\-–—]\s*/i,
