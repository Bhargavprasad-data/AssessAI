        ...
        <div className="space-y-4 mb-6">
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 bg-white dark:bg-slate-900/40 p-3.5 rounded-2xl border border-slate-200 dark:border-white/10 shadow-sm">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5">
              ...
              <motion.div
                initial={false}
                animate={{ width: isSearchOpen || searchQuery ? 290 : 125 }}
                transition={{
                  duration: 0.32,
                  ease: [0.16, 1, 0.3, 1],
                }}
                ...
                className={`relative flex items-center h-[38px] rounded-xl border transition-all duration-300 overflow-hidden cursor-pointer ${
                  isSearchOpen || searchQuery
                    ? 'border-brand-500/70 dark:border-brand-400/70 bg-white dark:bg-slate-950 shadow-md ring-2 ring-brand-500/20'
                    : 'border-slate-200 dark:border-white/10 bg-slate-50/80 dark:bg-slate-950/60 hover:border-brand-500/40 hover:bg-slate-100 dark:hover:bg-white/5'
                }`}
              >
                <motion.div
                ...
                <motion.span
                  ...
                  className="absolute left-9 text-xs font-semibold text-slate-700 dark:text-slate-300 pointer-events-none select-none whitespace-nowrap"
                >
                  Search Tests
                </motion.span>
              </motion.div>
            ...
            <table className="w-full text-left text-xs text-slate-600 dark:text-slate-300">
              <thead className="bg-slate-50 dark:bg-slate-950/60 text-[11px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider border-b border-slate-200 dark:border-white/10">
                <tr>
                  ...
                  <th scope="col" className="px-5 py-3.5">Faculty / Professor</th>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-fadeIn">
          <div className="max-w-lg w-full glass-panel rounded-3xl p-6 sm:p-8 border border-rose-500/40 bg-white dark:bg-slate-950 shadow-2xl text-left space-y-5">
            ...
            <div className="p-4 rounded-2xl bg-rose-500/5 dark:bg-rose-950/20 border border-rose-500/20 text-xs text-slate-700 dark:text-slate-300 space-y-2">
              ...
              <div>
                <span className="font-bold text-slate-900 dark:text-white">Faculty:</span>{' '}
